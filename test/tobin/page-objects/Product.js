class Product {
  ...
  /**
   * Methods to create a array with price of products in sorted order
   * @returns array with price
   */
  ...
  /**
   * Method to check the sorted order is correctly displayed.
   * @param {number} array 
   * @returns 
   */
  ...
  async mobileBrandSelect(brand) {
    ...
    await this.$appleHeader().waitForDisplayed({
      timeout: 500000, timeoutMsg: 'time out failed for brand filter'
    })
  }
  /**
